...
in shader:
`,t)}return r}},{key:`makeProgram`,value:function(){for(var e=this.gl,t=e.createProgram(),n=arguments.length,r=Array(n),i=0;i<n;i++)r[i]=arguments[i];if(r.forEach(function(n){e.attachShader(t,n)}),e.linkProgram(t),!e.getProgramParameter(t,e.LINK_STATUS)){var a=e.getProgramInfoLog(this.program);console.warn(a)}return t}},{key:`_bind`,value:function(){for(var e=this,t=arguments.length,n=Array(t),r=0;r<t;r++)n[r]=arguments[r];n.forEach(function(t){return e[t]=e[t].bind(e)})}}]),t}(A(HTMLElement));customElements.define(`shader-doodle`,I);const L=n({name:`1fiuwws`,styles:`position:relative;color:#fff;text-align:center;background-color:#159957;background-image:linear-gradient(120deg, #155799, #159957);padding:80px 100px`}),R=n({name:`1yoef68`,styles:`position:absolute;top:0;right:0;bottom:0;left:0;#shader{width:100%;height:100%;opacity:0.2;}`}),z=`
...
`,B=({children:e})=>{let t=(0,g.useRef)(null);return(0,g.useLayoutEffect)(()=>{t.current&&(t.current.innerHTML=z)},[]),i(`div`,{className:L,children:[r(`div`,{className:R,ref:t}),e]})},V=n({name:`1fx5xze`,styles:`font-size:20px;opacity:0.7;color:unset;text-decoration:unset`}),H=n({name:`h3anzh`,styles:`position:relative;font-size:50px;font-weight:bold`}),U=n({name:`1cu3yxh`,styles:`position:relative;margin-top:20px;margin-bottom:40px`}),W=()=>i(e,{children:[r(`div`,{className:H,children:`张振衣`}),r(`div`,{className:U,children:r(`a`,{className:V,href:`https://zhihu.com/people/dancerphil`,children:`https://zhihu.com/people/dancerphil`})})]}),G=n({name:`13qx8f4`,styles:`max-width:1000px;margin:0 auto;padding:60px 0;a{color:#1e6bb8;text-decoration:none;:hover{text-decoration:underline;}}`}),K=n({name:`1azakc`,styles:`text-align:center`}),q=n({name:`rj9gtv`,styles:`margin-bottom:16px;font-size:20px;font-weight:500;color:#159957`}),J=({children:e})=>r(`div`,{className:q,children:e}),Y=({href:e,children:t})=>r(`div`,{children:r(`a`,{target:`_blank`,href:e,rel:`noreferrer`,children:t})}),X=n({name:`wk4k1s`,styles:`margin-top:4px;margin-bottom:16px;color:rgba(0, 0, 0, 0.45)`}),Z=({children:e})=>r(`div`,{className:X,children:e}),Q=()=>i(e,{children:[r(B,{children:r(W,{})}),i(`div`,{className:G,children:[r(J,{children:`导航`}),r(Y,{href:`./tlp`,children:`《逻辑哲学论》——维特根斯坦`}),r(b,{}),r(J,{children:`目前正在维护的库`}),r(Y,{href:`https://github.com/regionjs/region-core`,children:`region-core`}),r(Z,{children:`react 状态管理`}),r(b,{}),r(J,{children:`玩具箱页面导航`}),r(Y,{href:`./coder`,children:`coder`}),r(Z,{children:`一个基于 localStorage 的在线的编辑器`}),r(Y,{href:`./mbti`,children:`mbti八维分析工具`}),r(Y,{href:`./10/once.html`,children:`10 随机迷宫`}),r(Y,{href:`./b`,children:`base64 背景图`}),r(Y,{href:`https://codepen.io/dancerphil/pen/POdeWy`,children:`纯 css 动画：bees`}),r(Y,{href:`https://codepen.io/dissimulate/pen/eZxEBO`,children:`窗帘动画 from codepen`}),r(Y,{href:`./d`,children:`任务管理`}),r(Y,{href:`https://codepen.io/dancerphil/pen/dRmLza`,children:`自动旋转的画图工具`}),r(Y,{href:`./m`,children:`material-design v0 颜色分析`}),r(Y,{href:`https://vincentgarreau.com/particles.js/`,children:`particles 动画`}),r(Y,{href:`./react-children-type`,children:`React Children Type`}),r(Y,{href:`https://seenjs.io/demo-2048.html`,children:`3d 2048 游戏`}),r(Y,{href:`./spiral-path`,children:`单词向量游戏`}),r(Y,{href:`./w`,children:`纯 css 动画`}),r(b,{}),i(`div`,{className:K,children:[`With Love. `,r(`a`,{target:`_blank`,href:`https://github.com/dancerphil`,rel:`noreferrer`,children:`Dancerphil`})]})]})]});var $=t(a());const ee=(0,$.createRoot)(document.body);ee.render(r(Q,{}));